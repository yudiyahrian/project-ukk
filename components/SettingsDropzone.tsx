...
const SettingsDropzone = ({ initialValue, progress, ...props }: Props) => {
  ...
  return (
    <div className="flex items-center gap-8">
          ...
          <>
            {initialValue ? (
              ...
              <div className="relative w-full h-full">
                <div
                  className={cn(
                    "w-full h-full flex flex-col items-center justify-center gap-2 text-[#505050]",
                    props.width <= 220 && "scale-90"
                  )}
                >
      ...
      <div
        className={cn(
          "transition-all shadow-md rounded-lg flex items-center justify-center flex-col opacity-0 duration-500",
          showProgress && "duration-200 opacity-100"
        )}
